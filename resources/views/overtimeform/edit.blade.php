                        ...
                        <div class="ibox-content">
                            ...
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Full Name:</label>
                                        <div class="col-sm-10"><input type="text" name="name" id="name" class="form-control" value="{{$header->name}}"></div>
                                </div>

                                <div class="form-group"><label class="col-sm-2 control-label">Employee Number:</label>
                                        <div class="col-sm-10"><input type="text" name="employee_no" class="form-control" value="{{$header->employee_no}}"></div>
                                </div>
